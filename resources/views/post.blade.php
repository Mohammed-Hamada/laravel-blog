<x-layout>
    <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
        <div class="col-span-4 lg:text-center lg:pt-14 mb-10">
            ...
            <img src="{{Storage::disk('local')->url($post->thumbnail)}}" alt=""
                class="rounded-xl">
            ...
            @auth
                <form method="POST" action="/posts/{{ $post->slug }}/comments"
                    ...
                    <header class="flex items-center">
                        <img src="https://i.pravatar.cc/60/?u={{ auth()->id() }}" class="rounded">

                        <h2>Want to participate?</h2>
                    </header>

                    <div class="mt-6">
                        <textarea placeholder="Do you have anything to say?" class="w-full" name="body" id="" rows="5"></textarea>
                    </div>

                    <div class="flex justify-end mt-10 border-t border-gray-200 pt-6">
                        <button type="submit" class="bg-blue-500 text-white p-2 rounded">Comment</button>
                    </div>
                </form>
            @endauth
